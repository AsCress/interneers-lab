...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        uncategorized_category = ProductCategoryService.get_category_by_title(title="Uncategorized")
        ...
        for product in uncategorized_products:
            ...
            try:
                ...
                self.stderr.write(self.style.ERROR(f"Failed to update product {product.id}"))
